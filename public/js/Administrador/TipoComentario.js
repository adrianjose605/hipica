...
controller('tipocomentario', ['$scope','$http','$mdToast', function($scope, $http,$mdToast){
	$scope.obj={};
	$scope.obj2={};
	...
	$scope.crear_nuevo= function(tipo){
		...
		if(tipo){
			url='Admin/tipoComentario/crear_tipo_comentario';
			obj=$scope.obj;
		}else{
			url='Admin/tipoComentario/modificar_tipo_comentario';
			obj=$scope.obj2;
		}
		console.log(url);
		console.log(obj);
	...
	$scope.get= function(id){		
		$http.get('Admin/tipoComentario/ver/'+id).
		success(function(data, status, headers, config) {				
	...
	$scope.getResource = function (params, paramsObj) {	
		...
		var urlApi = 'Admin/tipoComentario/tabla_principal_tipo_comentario/'+paramsObj.count+'/'+paramsObj.page+'/';
		if(paramsObj.sortBy){
