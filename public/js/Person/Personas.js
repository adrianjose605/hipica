angular.module('hipica')
        .controller('personas', ['$scope', '$http', '$mdToast', function ($scope, $http, $mdToast) {
                ...
                $scope.getResource = function (params, paramsObj) {
                   ...
                   $scope.paginador = paramsObj;
                    ...
                    var urlApi = 'Person/personas/tabla_principal/' + paramsObj.count + '/' + paramsObj.page + '/';
                    if (paramsObj.sortBy) {
        ...
        .controller('new_personas',['$scope', '$http', '$mdToast', function ($scope, $http, $mdToast){
              $scope.user = {};  
        }])
        .controller('info_persona',['$scope', '$http', '$mdToast', function ($scope, $http, $mdToast){
        }]);
