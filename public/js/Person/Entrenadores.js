angular.module('hipica')
        .controller('entrenadores', ['$scope', '$http', '$mdToast', function ($scope, $http, $mdToast) {
                ...
                $scope.getResource = function (params, paramsObj) {
                   ...
                   $scope.paginador = paramsObj;
                    ...
                    var urlApi = 'Person/entrenadores/tabla_principal/' + paramsObj.count + '/' + paramsObj.page + '/';
                    if (paramsObj.sortBy) {
        ...
        .controller('info_entrenador',['$scope', '$http', '$mdToast', function ($scope, $http, $mdToast){
              $scope.user = {};  
        }]);
