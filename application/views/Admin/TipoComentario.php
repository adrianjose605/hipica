<div class="container" ng-controller="tipocomentario" layout="column" flex id="content">
    <div class="container" style="width:95%">

<h1>Tipos de Comentario</h1>
    <h3>Busqueda</h3>
    ...
    <div class="modal-dialog">                
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Nuevo Tipo de Comentario</h4>
            </div>
...
<div id="edicion" class="modal fade" role="dialog">
    <div class="modal-dialog">                
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" ng-click="resetForm();" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Modificar Tipo de Comentario</h4>
            </div>
            <div class="modal-body">                               
...
<script src="<?php echo base_url(); ?>public/js/Administrador/TipoComentario.js"></script>
