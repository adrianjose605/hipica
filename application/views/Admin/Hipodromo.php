<div class="container" ng-controller="hipodromo"layout="column" flex id="content">
    ...
    <div class="modal-dialog">                
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Nuevo Hipodromo</h4>
            </div>
            <div class="modal-body">                
                ...
                <form class="form-inline" name="crear" role="form" novalidate>
                 <div class="form-group">
                    ...
                    <input ng-model="obj.descripcion" maxlength="30"  pattern="^[a-zA-Z0-9áéíóúñ_]+( [a-zA-Z0-9áéíóúñ _]+)*$" name="nombre_pais" type="text"  ng-required="true">
        ...
        <div class="form-group">
            ...
            <input ng-model="obj.abreviatura" maxlength="2"  pattern="[a-zA-Z]+" name="abre" type="text"  ng-required="true">
...
<div class="form-group">
    ...
    <md-select name="tipos" md-on-open="cargarTipos()" placeholder="Pais" ng-model="obj.pais" required>      
...
<div id="edicion" class="modal fade" role="dialog">
    <div class="modal-dialog">                
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" ng-click="resetForm();" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Modificar Hipodromo</h4>
            </div>
            <div class="modal-body">                               
            <form class="form-inline" name="modificar" role="form" novalidate>
                 <div class="form-group">
                    <md-input-container flex>
                    <label>Descripcion</label>
                    <input ng-model="obj2.descripcion" maxlength="30"  pattern="^[a-zA-Z0-9áéíóúñ_]+( [a-zA-Z0-9áéíóúñ _]+)*$" name="nombre_pais" type="text"  ng-required="true">
        ...
        <div class="form-group">
            <md-input-container flex>
            <label>Abreviatura</label>
            <input ng-model="obj2.abreviatura" maxlength="2"  pattern="[a-zA-Z]+" name="abre" type="text"  ng-required="true">
...
<div class="form-group">
    ...
    <md-select name="tipos" md-on-open="cargarTipos()" placeholder="Paises" ng-model="obj2.pais" required>      
    <md-option ng-repeat="tcon in spaises"  ng-value="tcon.id" >{{tcon.val}}</md-option>
</md-select>
...
<script src="<?php echo base_url(); ?>public/js/Administrador/Hipodromo.js"></script>
