<div class="container" ng-controller="tipounidad" layout="column" flex id="content">
    <div class="container" style="width:95%">

<h1>Tipos de Unidades</h1>
    <h3>Busqueda</h3>
    ...
    <div class="modal-dialog">                
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Nuevo Tipo de Unidad</h4>
            </div>
            <div class="modal-body">                
                    ...
                    <div class="form-group">
                        <md-input-container flex>
                        <label>Descripcion</label>
                        <input maxlength="15" ng-model="obj.descripcion" ng-required="true"  pattern="[a-zA-Z]+" type="text" name="descripcion_c">
...
<div id="edicion" class="modal fade" role="dialog">
    <div class="modal-dialog">                
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" ng-click="resetForm();" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Modificar Tipo de Unidad</h4>
            </div>
            <div class="modal-body">                               
                ...
                <form class="form-inline" name="modificar" role="form" novalidate>
                    ...
                    <div class="form-group">
                        <md-input-container flex>
                        <label>Descripcion</label>
                        <input maxlength="15" ng-model="obj2.descripcion" ng-required="true"  pattern="[a-zA-Z]+" type="text" name="descripcion_c">
...
<script src="<?php echo base_url(); ?>public/js/Administrador/TipoUnidad.js"></script>
