    ...
    <table class="table table-striped table-condensed" >
        ...
        <tbody>
            <tr ng-repeat="row in rows" class="centrado">
                ...
                <td>
                    <div class="btn-group">
                        <a class="btn btn-material-indigo btn-xs" href=""  ng-click="getTipoPista(row.Opciones)" data-toggle="modal" data-target="#edicion_tipo_pista"><span class="glyphicon glyphicon-search"></span></a>
                    </div>
                </td>
