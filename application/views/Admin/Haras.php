<div class="container" ng-controller="haras" layout="column" flex id="content">
    ...
    <div class="modal-dialog">                
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Nuevo Hara</h4>
            </div>
            <div class="modal-body">                
                ...
                <form class="form-inline" name="crear" role="form" novalidate>
                    <div class="form-group">
                        <md-input-container flex>
                        <label>Nombre</label>
                        <input ng-model="obj.nombre" maxlength="30"  pattern="^[a-zA-Z0-9áéíóúñ_]+( [a-zA-Z0-9áéíóúñ _]+)*$" name="nombre_pais" type="text"  ng-required="true">
            ...
            <div class="form-group">
                ...
                <input maxlength="15" ng-model="obj.abrev" ng-required="true"  pattern="^[a-zA-Z0-9áéíóúñ_]+( [a-zA-Z0-9áéíóúñ _]+)*$" type="text" name="descripcion_c">
                <ng-messages for="crear.descripcion_c.$error" role="alert" ng-if="submitted">
                <ng-message when="required">Debe indicar una Aberviatura</ng-message>
...
<div id="edicion" class="modal fade" role="dialog">
    <div class="modal-dialog">                
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" ng-click="resetForm();" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Modificar Haras</h4>
            </div>
            <div class="modal-body">                               
                ...
                <form class="form-inline" name="modificar" role="form" novalidate>
                    <div class="form-group">
                        <md-input-container flex>
                        <label>Nombre</label>
                        <input ng-model="obj2.nombre" maxlength="30"  pattern="^[a-zA-Z0-9áéíóúñ_]+( [a-zA-Z0-9áéíóúñ _]+)*$" name="nombre_pais" type="text"  ng-required="true">
            ...
            <div class="form-group">
                <md-input-container flex>
                <label>Abreviatura</label>
                <input maxlength="15" ng-model="obj2.abrev" ng-required="true"  pattern="^[a-zA-Z0-9áéíóúñ_]+( [a-zA-Z0-9áéíóúñ _]+)*$" type="text" name="descripcion_c">
...
<script src="<?php echo base_url(); ?>public/js/Administrador/Haras.js"></script>
