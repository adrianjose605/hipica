<div class="container" ng-controller="tipoorigen" layout="column" flex id="content">
    <div class="container" style="width:95%">

<h1>Tipos de Origen</h1>
    <h3>Busqueda</h3>
    ...
    <div class="modal-dialog">                
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Nuevo Tipo de Origen</h4>
            </div>
            <div class="modal-body">                
             ...
             <div class="form-group">
                                <md-input-container flex>
                                    ...
                                    <input ng-model="obj.abreviatura" maxlength="3" ng-required="true"  pattern="[a-zA-Z]+" type="text" name="abreviatura_pais">
...
<div id="edicion" class="modal fade" role="dialog">
    <div class="modal-dialog">                
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" ng-click="resetForm();" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Modificar El Tipo de Origen</h4>
            </div>
            <div class="modal-body">                               
            ...
            <div class="form-group">
                                <md-input-container flex>
                                    <label>Abreviatura</label>
                                    <input ng-model="obj2.abreviatura" maxlength="3" ng-required="true"  pattern="[a-zA-Z]+" type="text" name="abreviatura_pais">
                                    <ng-messages for="modificar.abreviatura_pais.$error" role="alert" ng-if="submitted">
                                        <ng-message when="required">Debe indicar una Abreviatura</ng-message>
                                        <ng-message when="pattern">No se permiten Caracteres especiales</ng-message>  
                                    </ng-messages>
                                </md-input-container>
...
<script src="<?php echo base_url(); ?>public/js/Administrador/TipoOrigen.js"></script>
