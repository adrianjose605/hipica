<div ng-controller="entrenadores" layout="column" flex id="content">
            ...
            <table class="table table-striped table-condensed" >
                ...
                <tbody>
                    <tr ng-repeat="row in rows" class="centrado">
                        ...
                        <td>
                            <div class="btn-group">
                                <a class="btn btn-material-blue btn-xs" href=""  ng-click="navigateTo('Person/jinetes/info')" data-toggle="modal" data-target="#modificar_pais"><span class="glyphicon glyphicon-search"></span></a>
                            </div>
                        </td>
...
<script src="<?php echo base_url(); ?>public/js/Person/entrenadores.js"></script>