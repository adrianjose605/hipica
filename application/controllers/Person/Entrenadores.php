...
class Entrenadores extends CI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->load->model('Entrenadores_model');
    }

    
    public function ver_busqueda($descripcion) {
        $result = $this->Entrenadores_model->search_entrenadores($descripcion);
        $res = array();
    ...
    public function tabla_principal($count = 5, $page = 1, $order = 'ID', $type = 'asc'){
        ...
        $array = $this->Entrenadores_model->generar_json_tabla_principal($inicio, $count, $order, $type);
    ...
    public function index() {
        ...
        $this->load->view('Person/Entrenadores', $data);
